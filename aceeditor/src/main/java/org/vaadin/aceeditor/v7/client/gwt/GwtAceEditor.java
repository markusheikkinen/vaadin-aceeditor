package org.vaadin.aceeditor.v7.client.gwt;
...
public class GwtAceEditor extends JavaScriptObject {
	...
	public final native void addChangeHandler(GwtAceChangeHandler handler) /*-{
		var cb = function(event) {
			handler.@org.vaadin.aceeditor.v7.client.gwt.GwtAceChangeHandler::onChange(Lorg/vaadin/aceeditor/v7/client/gwt/GwtAceChangeEvent;)(event);
		}
	...
	public final native void addChangeCursorHandler(
		...
		var cb = function(event) {
			handler.@org.vaadin.aceeditor.v7.client.gwt.GwtAceChangeCursorHandler::onChangeCursor(Lorg/vaadin/aceeditor/v7/client/gwt/GwtAceEvent;)(event);
		}
	...
	public final native void addChangeSelectionHandler(
		...
		var cb = function(event) {
			handler.@org.vaadin.aceeditor.v7.client.gwt.GwtAceChangeSelectionHandler::onChangeSelection(Lorg/vaadin/aceeditor/v7/client/gwt/GwtAceEvent;)(event);
		}
	...
	public final native void setKeyboardHandler(GwtAceKeyboardHandler handler) /*-{
		var h = { handleKeyboard: function(data, hashId, keyString, keyCode, e) {
			...
			var command = handler.@org.vaadin.aceeditor.v7.client.gwt.GwtAceKeyboardHandler::handleKeyboard(Lcom/google/gwt/core/client/JavaScriptObject;ILjava/lang/String;ILorg/vaadin/aceeditor/v7/client/gwt/GwtAceKeyboardEvent;)(data, hashId, keyString, keyCode, e);
			if (command===@org.vaadin.aceeditor.v7.client.gwt.GwtAceKeyboardHandler$Command::NULL) {
				return {command: "null"};
			}
		}};
	...
	public final native void addFocusListener(GwtAceFocusBlurHandler handler) /*-{
		var focus = function(event) {
			handler.@org.vaadin.aceeditor.v7.client.gwt.GwtAceFocusBlurHandler::onFocus(Lorg/vaadin/aceeditor/v7/client/gwt/GwtAceEvent;)(event);
		}
		var blur = function(event) {
			handler.@org.vaadin.aceeditor.v7.client.gwt.GwtAceFocusBlurHandler::onBlur(Lorg/vaadin/aceeditor/v7/client/gwt/GwtAceEvent;)(event);
		}
